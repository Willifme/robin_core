...
mod parser_tests {
    ...
    fn parse_a_single_lower_exponent_digit() {
        assert_eq!(parser::exponent_part_digits_literal(b"e6"), IResult::Done(&b""[..], 6.0));
    }

    #[test]
    fn parse_multiple_single_digits() {
        assert_eq!(parser::exponent_part_digits_literal(b"e66"), IResult::Done(&b""[..], 66.0));
    }

    #[test]
    fn parse_a_single_upper_exponent_digit() {
        assert_eq!(parser::exponent_part_digits_literal(b"E7"), IResult::Done(&b""[..], 7.0));
    }

    #[test]
    fn parse_multiple_upper_digits() {
        assert_eq!(parser::exponent_part_digits_literal(b"E77"), IResult::Done(&b""[..], 77.0));
    }
}